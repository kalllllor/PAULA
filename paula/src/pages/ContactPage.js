            ...
            <div className="contactPage__Section">
              ...
              <div className="container__content">
                <div className="content__left">
                  ...
                  <p>
                    <h4>Poniedziałek - Piątek:</h4> 7:00 - 18:00
                  </p>
                  <p>
                    <h4>Sobota:</h4> 7:00 - 14:00
                  </p>
                  <p>
                    <h4>Niedziela:</h4> nieczynne
                  </p>
                </div>
            ...
            <div className="contactPage__Section">
              ...
              <div className="container__content">
                <div className="content__left">
                  <h2>GODZINY OTWARCIA</h2>
                  <p>
                    <h4>Poniedziałek - Piątek:</h4> 7:00 - 17:00
                  </p>
                  <p>
                    <h4>Sobota:</h4> 7:00 - 14:00
                  </p>
            ...
            <div className="contactPage__Section">
              ...
              <div className="container__content">
                <div className="content__left">
                  <h2>GODZINY OTWARCIA</h2>
                  <p>
                    <h4>Poniedziałek - Piątek:</h4> 8:30 - 19:00
                  </p>
                  <p>
                    <h4>Sobota:</h4> 8:00 - 19:00
                  </p>
                  <p>
                    <h4>Niedziela:</h4> nieczynne
                  </p>
              ...
              <div className="contact__map">
                ...
                <iframe
                  className="contact__googleMap"
                  title="oddzialSlomniki"
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2551.7871193724714!2d20.081506451610394!3d50.239881810294676!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x471652eb6eb9acf7%3A0x462ee9667a6524f8!2sDrogerie%20Polskie%20S%C5%82omniki!5e0!3m2!1spl!2spl!4v1591528617294!5m2!1spl!2spl"
                />
              </div>
            </div>
          </div>
