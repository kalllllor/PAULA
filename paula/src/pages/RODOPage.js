                    ...
                    <div style={{ borderTop: "solid 3vh #FCC700" }}>
                        <div className="RODOPage__content">
                            ...
                            <div className="RODOPage__text">
                                ...
                                <p>W związku z zmianą przepisów dotyczących ochrony danych osobowych, określaną popularnie jako RODO, informujemy, iż decydując się na kontakt z nami wyrażasz zgodę na przetwarzanie Twoich danych osobowych przez naszą firmę – Skład Materiałów Budowlanych AX-BUD Fudalińska Maria, z siedzibą w Siercza 371, 32-020 Wieliczka, Regon: 357135491, NIP: 683-124-15-83. Głównym celem nowych przepisów jest zapewnienie większego bezpieczeństwa i większej ochrony przy przetwarzaniu Twoich danych osobowych. Wiadomość ta jest spełnieniem obowiązku informacyjnego wynikającego z RODO. </p>
                                <p>W trosce o Twoje dane osobowe informujemy, że administratorem Twoich danych osobowych jest  Skład Materiałów Budowlanych AX-BUD Fudalińska Maria, z siedzibą w Siercza 371, 32-020 Wieliczka, Regon: 357135491, NIP: 683-124-15-83 (dalej AX-BUD).</p>
                                <p>Pamiętaj, że przysługuje Ci prawo do wglądu do swoich danych, prawo do cofnięcia zgody na ich przetwarzanie, prawo do żądania ich sprostowania, poprawiania, usunięcia lub ograniczenia przetwarzania,  a także do przenoszenia danych, wyrażenia sprzeciwu i wniesienia skargi do organu nadzorczego. Uprawnienie to możesz zrealizować kontaktując się z nami pisemnie na adres: Skład Materiałów Budowlanych AX-BUD Fudalińska Maria, Sieraków 132, 32-410 Dobczyce lub poprzez adres email: biuro@axbud.com</p>
